...
set output 'cluster/ld/TMU_WTD/TMU_WTD_t03.png'
set tics nomirror
...
plot 'cluster/ld/TMU_WTD/t03.dat' u 1:(k0($2)) t 'K_1' w boxes lc rgb '#99C7EC',\
'' u 1:(k1($2)) t 'K_2' w boxes lc rgb '#FFFAD2',\
'' u 1:(k2($2)) t 'K_3' w boxes lc rgb '#F5A275',\
'gnu/ld/plot/TMU_WTD.dat' u 1:($12) t 'A1' w lp ls 1,\
