...
set output 'cluster/hd/CH_WTD/CH_WTD_t03.png'
set tics nomirror
...
plot 'cluster/hd/CH_WTD/t03.dat' u 1:(k0($2)) t 'K_1' w boxes lc rgb '#99C7EC',\
'' u 1:(k1($2)) t 'K_2' w boxes lc rgb '#FFFAD2',\
'' u 1:(k2($2)) t 'K_3' w boxes lc rgb '#F5A275',\
'gnu/hd/plot/CH_WTD.dat' u 1:($12) t 'C1' w lp ls 1,\
